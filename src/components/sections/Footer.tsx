    ...
    <footer className="bg-brand-charcoal text-white pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-4 items-center md:items-start">
                ...
                <div className="flex gap-4">
                   <a href="https://www.facebook.com/profile.php?id=61573173656596" target="_blank" rel="noopener noreferrer" className="bg-white/5 p-3 rounded-xl hover:bg-brand-yellow hover:text-brand-charcoal transition-all">
                     <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.03 1.764-5.908 5.43-5.908 1.489 0 3.002.233 3.002.233v2.532h-1.294c-1.998 0-2.623 1.24-2.623 2.51v1.713h3.147l-.503 3.667h-2.644v7.98h-3.515z"/></svg>
                   </a>
                   <a href="https://www.instagram.com/joannesdrivingschool" target="_blank" rel="noopener noreferrer" className="bg-white/5 p-3 rounded-xl hover:bg-brand-yellow hover:text-brand-charcoal transition-all">
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex flex-col md:flex-row items-center gap-4 order-2 md:order-1 text-center md:text-left">
            <p className="text-slate-500 text-[10px] md:text-xs font-medium">
              © {currentYear} Joanne's Driving School.
            </p>
            {/* New Policy Links */}
            <div className="flex gap-4">
              <Link href="/terms" className="text-slate-500 hover:text-brand-yellow text-[10px] uppercase font-bold tracking-widest transition-colors">
                Terms
              </Link>
              <Link href="/privacy" className="text-slate-500 hover:text-brand-yellow text-[10px] uppercase font-bold tracking-widest transition-colors">
                Privacy
              </Link>
            </div>
          </div>
